		...
		<div class="right-column float-view content-area span9">
			<div class="content-page">
				<article>
					...
					<!--h2>Demos</h2>
					<p>You can test some request calls by going to the API Console. It is connected to a dummy database so any add/deletes you do will not effect the main MobSci database.</p>
					<p>Alternatively, you can download the Java implementation code that makes similar calls but uses apache http client object to make the POST requests. It should help android programmers obtain code to make the calls. The dependencies are also included.</p>
					<ul>
						<li><a href="demo/">MobSci API Console</a></li>
						<li><a href="archive/java.master.zip">Java - MobSci Test Calls</a></li>
					</ul>
					<p class="muted">Both interfaces are attached to the same dummy database, which is a mirror of the real MobSci DB structure.</p-->
